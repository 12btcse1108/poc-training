...
public class StockTickerLirDG {

	private static String code = "G";
	...
	private static void generateData(String restEndPoint, String topic) {
		try {
			...
			switch (code) {
			case "A":
				dataToPublish = previous_close + "," + current_trade_price;
				break;
			case "B":
				dataToPublish = previous_trade_price + "," + current_trade_price;
				break;
			case "C":
				dataToPublish = previous_change_percent + "," + current_trade_price;
				break;
			case "D":
				dataToPublish = previous_close + "," + previous_trade_price + "," + current_trade_price;
				break;
			case "E":
				dataToPublish = previous_close + "," + previous_change_percent + "," + current_trade_price;
				break;
			case "F":
				dataToPublish = previous_trade_price + "," + previous_change_percent + "," + current_trade_price;
				break;
			case "G":
